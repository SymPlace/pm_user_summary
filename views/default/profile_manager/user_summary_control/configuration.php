...
$add_icon = "<span class='elgg-icon fa fa-plus-circle elgg-icon-profile-manager-user-summary-config-add' title='" . elgg_echo("add") . "'></span>";
...
$body = elgg_view("input/form", array("body" => $form_body, "action" => "action/pm_user_summary/user_summary_control/save"));
